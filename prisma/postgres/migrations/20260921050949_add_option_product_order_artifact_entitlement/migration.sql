...
CREATE TABLE "OptionOrder" (
    ...
    CONSTRAINT "OptionOrder_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PlanEntitlementUsage" (
    ...
    CONSTRAINT "PlanEntitlementUsage_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "OptionOrder" ADD CONSTRAINT "OptionOrder_clinicId_fkey" FOREIGN KEY ("clinicId") REFERENCES "Clinic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OptionOrder" ADD CONSTRAINT "OptionOrder_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "Contact"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OptionOrder" ADD CONSTRAINT "OptionOrder_productId_fkey" FOREIGN KEY ("productId") REFERENCES "OptionProduct"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OptionOrder" ADD CONSTRAINT "OptionOrder_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Diagnosis"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GeneratedArtifact" ADD CONSTRAINT "GeneratedArtifact_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "OptionOrder"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GeneratedArtifact" ADD CONSTRAINT "GeneratedArtifact_clinicId_fkey" FOREIGN KEY ("clinicId") REFERENCES "Clinic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PlanEntitlementUsage" ADD CONSTRAINT "PlanEntitlementUsage_clinicId_fkey" FOREIGN KEY ("clinicId") REFERENCES "Clinic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ClinicAuditLog" ADD CONSTRAINT "ClinicAuditLog_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "Contact"("id") ON DELETE SET NULL ON UPDATE CASCADE;
